...
<body>
    <div class="container mb-5">
        ...
        <div class="row text-center g4">
            ...
            <div class="col-md-6">
                <div class="card">
                    <img src="images/tmb.png" class="card-img-top" alt="Registrasi">
                    <div class="card-body">
                        <h5 class="card-title"><a href="tes.jsp" style="text-decoration:none; color:black;">Tes Minat Bakat</a></h5>
                        <p class="card-text">Temukan jurusan yang paling sesuai dengan minat dan bakatmu.</p>
                    </div>
                </div>
            </div>
            <div class="col-md-6">
